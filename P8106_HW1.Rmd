...
# Using 1se cross-validation. Code from: https://www.rdocumentation.org/packages/caret/versions/6.0-92/topics/oneSE
...
The cross validation plot shows the RMSE values were fairly stable until ~exp(6). Therefore, the selected tuning parameters are alpha = 0.05 and lambda = 622.8735. 
...
From this, the test error of the model is 438172327.